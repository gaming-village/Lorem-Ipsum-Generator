...
//       const wordsInCategory = currentValue.words.filter(word => word.category === category);
//       return previousValue.concat(wordsInCategory as Array<never>);
//    }, []);

//    // Choose a random word
//    const randomWord: Word = randItem(availableWords);
...
// const getWordWithName = (name: string): Word => {
...
//          newWord = getWordFromCategory(value[0][1][0] as unknown as WordCategory);
...
// const findWord = (sentence: string, wordEndIndex: number): Word => {
...
//       for (const word of loremPack.words) {
...
//    const wordTables: Array<JSX.Element> = packInfo.words.map((word, i) => {
//       return (
//          <tr key={i}>
//             <td>{word.latin}</td>
//             <td>{word.meaning}</td>
...
//       for (const word of packInfo.words) {
